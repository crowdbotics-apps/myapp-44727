"""
Django settings for myapp_44727 project.
...
WSGI_APPLICATION = 'myapp_44727.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "myapp_44727 API",
    "DESCRIPTION": "API documentation for myapp_44727 App",
    "VERSION": "v1",
}
